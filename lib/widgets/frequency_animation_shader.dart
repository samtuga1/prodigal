    ...
    return AnimatedSampler(
      ...
      (image, size, canvas) {
        ...
        if (data2Animation.isNotEmpty) {
          shader.setFloat(3, getDbfromFft(data2Animation[1 * indexFactor].value));
          shader.setFloat(4, getDbfromFft(data2Animation[2 * indexFactor].value));
          shader.setFloat(5, getDbfromFft(data2Animation[3 * indexFactor].value));
          shader.setFloat(6, getDbfromFft(data2Animation[4 * indexFactor].value));
          shader.setFloat(7, getDbfromFft(data2Animation[5 * indexFactor].value));
          shader.setFloat(8, getDbfromFft(data2Animation[6 * indexFactor].value));
        }
